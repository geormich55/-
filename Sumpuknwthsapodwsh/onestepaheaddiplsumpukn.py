...
dataset = pd.read_excel(r'DATAS.xlsx', sheet_name='Fullo1')
...
X1 = pd.DataFrame(datas, columns=['LPStTemp', 'AmbTemp', 'CondFlow', 'InletCond', 'OutletCond', 'CondTemp', 'CondLevel', 'Condefficiency'])
