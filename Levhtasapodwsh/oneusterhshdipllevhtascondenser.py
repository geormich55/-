...
H31 = pd.DataFrame(datas, columns=['Condenserefficiency'])
A38 = pd.DataFrame(datas, columns=['Condenserefficiency'])
for i in range(2904):
           H31.values[i+1,0]=A38.values[i,0]
A1['Condenserefficiency'] = A38
A1['Condenserefficiency(t-1)'] = H31
X1=A1
