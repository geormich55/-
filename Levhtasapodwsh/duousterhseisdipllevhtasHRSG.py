...
#dataset = pd.read_excel(r'C:\Users\Micha\Desktop\Diplwmatikh ELPE\Σχέσεις\python kai MATLAB arxeia\Levhtasapodwsh\Dataslevhtas-HRSG.xlsx', sheet_name='Fullo1')
dataset = pd.read_excel(r'Dataslevhtas-HRSG.xlsx', sheet_name='Fullo1')
...
for i in range(2905):
       n=0
       if Y1.values[i,0]<0.82 and i<2902 and Y1.values[i,0]!=0:
           Y1.values[i, 0] = 0
           I.append(i)
           n=1
           Y1.values[i+1,0]=0
           ...
           Y1.values[i + 3, 0] = 0
           I.append(i + 3)
       elif Y1.values[i,0]>0.876 and (i<2902) and Y1.values[i,0]!=0:
           Y1.values[i, 0] = 0
           I.append(i)
           n=1
           Y1.values[i+1,0]=0
